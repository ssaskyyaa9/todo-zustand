    ...
    <View style={{ flex: 1, backgroundColor: "#F4FAFF", }} >
      ...
      >
        ...
        <View style={{ flexDirection: "row", gap: 12, marginBottom: 28, }} >
          <View style={{ flex: 1, backgroundColor: "#FFFFFF", borderRadius: 18, padding: 17, borderWidth: 1, borderColor: "#E0EFF8", }} >
            <View style={{ width: 38, height: 38, borderRadius: 11, backgroundColor: "#E8F5FF", alignItems: "center", justifyContent: "center", marginBottom: 14, }} >
              <FileText size={19} color="#168CF5" strokeWidth={2} />
            </View>

            <Text style={{ fontSize: 22, fontWeight: "800", color: "#12344D", }} > {loading ? "..." : notes.length} </Text>
            <Text style={{ fontSize: 12, color: "#7893A6", marginTop: 3, }} > Total Notes </Text>
          </View>

          <View style={{ flex: 1, backgroundColor: "#FFFFFF", borderRadius: 18, padding: 17, borderWidth: 1, borderColor: "#E0EFF8", }} >
            <View style={{ width: 38, height: 38, borderRadius: 11, backgroundColor: "#E8F8F2", alignItems: "center", justifyContent: "center", marginBottom: 14, }} >
              <CheckCircle2 size={19} color="#20A779" strokeWidth={2} />
            </View>

            <Text style={{ fontSize: 22, fontWeight: "800", color: "#12344D", }} > {loading ? "..." : notes.length} </Text>
            <Text style={{ fontSize: 12, color: "#7893A6", marginTop: 3, }} > Saved Notes </Text>
          </View>
        </View>
        ...
        {loading ? (
          ...
          notes.slice(0, 3).map((note) => (
            <TouchableOpacity key={note.id} activeOpacity={0.8} style={{ backgroundColor: "#FFFFFF", borderRadius: 17, padding: 16, marginBottom: 10, flexDirection: "row", alignItems: "center", borderWidth: 1, borderColor: "#E0EFF8", }} >
              ...
              <View style={{ flex: 1, marginLeft: 13, }} >
                <Text numberOfLines={1} style={{ fontSize: 15, fontWeight: "700", color: "#193B52", marginBottom: 5, }} > {note.title} </Text>
      ...
      <View style={{ position: "absolute", left: 16, right: 16, bottom: 18, height: 68, backgroundColor: "#FFFFFF", borderRadius: 20, flexDirection: "row", alignItems: "center", justifyContent: "space-around", borderWidth: 1, borderColor: "#E0EFF8", shadowColor: "#12344D", shadowOffset: { width: 0, height: 4, }, shadowOpacity: 0.08, shadowRadius: 12, elevation: 5, }} >
        ...
        <TouchableOpacity activeOpacity={0.7} onPress={() => router.push("/notes")} style={{ alignItems: "center", justifyContent: "center", }} >
